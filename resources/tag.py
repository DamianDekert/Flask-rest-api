...
class Tags(MethodView):
    ...
    def post(self, tag_data, store_id):
        if TagModel.query.filter(
            ...
            abort(400, message="A tag with that name already exist in that")
        ...
        try:
            ...
            abort(500, message="Error handle in adding tag model")
...
class Tag(MethodView):
    ...
    def delete(self, tag_id):
        ...
        abort(400, message="Item can't be deleted")
...
class LinksTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, message="An err occurred while inserting the tag.")
